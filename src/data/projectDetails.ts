...
import screenIdle from "../assets/img/screen_idle.png"
import escolha from "../assets/img/screen_escolha.png"
import testando from "../assets/img/screen_testando.png"
import aprovado from "../assets/img/screen_aprovado.png"
import reprovado from "../assets/img/screen_reprovado.png"
import login from "../assets/img/screen_login.png"
import logs from "../assets/img/screen_logs.png"
import controle from "../assets/img/screen_controle.png"
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                subtitle: "Estado padrão do quiosque",
                text: "Exibe o manual de uso enquanto nenhum colaborador está realizando o teste.",
                image: screenIdle
            },
            {
                title: "Modal de escolha do teste",
                subtitle: "Pulseira ou calcanheira, decisão do colaborador",
                text: "Após identificação, o colaborador escolhe entre pulseira (1) ou calcanheira (2).",
                image: escolha
            },
            {
                title: "Teste em andamento",
                subtitle: "Leitura em tempo real via GPIO",
                text: "Indicador visual com animação de scan enquanto o teste está sendo realizado.",
                image: testando
            },
            {
                title: "Resultado — Aprovado",
                subtitle: "Dentro do limite de resistência esperado",
                text: "Exibido quando o colaborador passa no teste dentro do limite de resistência.",
                image: aprovado
            },
            {
                title: "Resultado — Reprovado",
                subtitle: "Reset automático após 3 segundos",
                text: "Exibido quando o colaborador não passa no teste. O sistema reseta automaticamente após 3 segundos.",
                image: reprovado
            },
            {
                title: "Segurança — Autenticação e proteção contra força bruta",
                subtitle: "Acesso administrativo do dashboard",
                text: "O acesso ao dashboard é protegido por login, com rate limiting (express-rate-limit) na rota de autenticação — bloqueia tentativas repetidas por IP após 5 tentativas em 15 minutos, mitigando ataques de força bruta. A autenticação atual atende ao uso interno da fábrica; a evolução para JWT com hash de senha (bcrypt) já está mapeada como próxima etapa, para suportar múltiplos usuários com permissões distintas.",
                image: login
            },
            {
                title: "Dashboard — Auditoria de logs",
                subtitle: "Rastreabilidade completa por colaborador",
            ...
            },
            {
                ...
                subtitle: "Para controlar e visualizar quem deve fazer o teste",
